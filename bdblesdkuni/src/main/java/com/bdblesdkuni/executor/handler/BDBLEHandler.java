...
import com.bdblesdkuni.BeidouParams;
import com.bdblesdkuni.executor.thread.revThread;
import com.bdblesdkuni.executor.thread.rssiThread;
import com.bdblesdkuni.executor.thread.sendThread;
...
//    }
     ...
     * @param paramArrayOfByte
     *         发送的比特串
     *         最终各种发送函数把各自的参数传进来在这里实现发送功能
     */
    @Override
    public void send(final byte[] paramArrayOfByte) {
        //调用发送线程的setSendTempMsg方法把传 入的参数存入 MessageTempList集合中
