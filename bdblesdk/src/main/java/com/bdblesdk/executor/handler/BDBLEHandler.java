...
/**
 * BLE蓝牙管理类
 * 该类可直接对蓝牙操作，连接断开，发送与接收，不涉及协议，但不建议直接用此类进行蓝牙写入操作。
 *
...
public class BDBLEHandler extends baseHandler{
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            ...
            Log.v("FDBDTestLog","onServicesDiscovered");
        ...
        public void onCharacteristicWrite(BluetoothGatt paramGatt,
            ...
            Log.v("FDBDTestLog","收到onCharacteristicWrite"+paraCharacteristic.getStringValue(0));
        }
        ...
        public void onCharacteristicRead(BluetoothGatt gatt,
            ...
            Log.v("FDBDTestLog","收到onCharacteristicRead"+characteristic.getStringValue(0));
        }
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,
            ...
            Log.v("FDBDTestLog","收到onCharacteristicChanged"+characteristic.getStringValue(0));
            if (!pause) {
     ...
     * @param paramContext  上下文
     * @param paramBDBLEListener  监听
     * @param UUID_RX  接收通道UUID
     * @param UUID_TX  发送通道UUID
     */
     ...
     *
     * @param address 蓝牙设备的物理地址
     * @return 连接成功后范围true，否则false
     */
    protected boolean connectDevice(final String address) {
            ...
            while (localIterator2.hasNext()) {
                ...
                if (UUID_RX_DATA == "" || UUID_TX_DATA == "") {
                    ...
                    if (localBluetoothGattCharacteristic.getUuid().toString()
                            .equals(UUID_RX_DATA_1)) {
                        Log.v("FDBDTestLog","找到UUID_RX_DATA_1");
                        //Log.v("FDBDTestLog","找到UUID_RX_DATA_1"+" 服务uuid "+testService.getUuid().toString());
                        setCharacteristicNotification(
                                localBluetoothGattCharacteristic, true);
                        this.mRXCharacteristic = localBluetoothGattCharacteristic;
                    }
                    if (localBluetoothGattCharacteristic.getUuid().toString()
                            .equals(UUID_TX_DATA_1)) {
                        Log.v("FDBDTestLog","找到UUID_TX_DATA_1");

                        //Log.v("FDBDTestLog","找到UUID_TX_DATA_1"+" 服务uuid "+testService.getUuid().toString());
                        setCharacteristicNotification(
                                localBluetoothGattCharacteristic, true);
                    ...
                    if (localBluetoothGattCharacteristic.getUuid().toString()
                            .equals(UUID_RX_DATA)) {
                        Log.v("FDBDTestLog","找到UUID_RX_DATA");
